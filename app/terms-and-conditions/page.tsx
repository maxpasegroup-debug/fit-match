...
export default function TermsPage() {
  return <PolicyPage title="Terms and Conditions" updated="July 9, 2026" sections={[
    { title: "Use of service", body: "FIT & MATCH is provided for customers to browse FIT & MATCH collections, maintain fit profiles, purchase products, and manage account services." },
